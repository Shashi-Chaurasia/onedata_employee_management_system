...
export default function Student() {
    ...
    return (
        <>
            <Container>
                ...
                <Paper elevation={3} style={paperStyle}>
                    ...
                    <Box
                        ...
                        noValidate
                        autoComplete="off">
                        <TextField id="outlined-basic" className='employee__infoInput' label="Employee Name" variant="outlined"
                            value={empName}
                            onChange={(e) => setName(e.target.value)}
                        />
                        <TextField id="outlined-basic" className='employee__infoInput' label="Employee Email" variant="outlined"
                            value={empEmail}
                            onChange={(e) => setEmail(e.target.value)} />

                        <TextField id="outlined-basic" className='employee__infoInput' label="Employee DepartmentId" variant="outlined" value={empDepId}
                            onChange={(e) => setDepId(e.target.value)}/>
                        <TextField id="outlined-basic" className='employee__infoInput' label="Employee Salary" variant="outlined" value={empSalary}
                            onChange={(e) => setSalary(e.target.value)}/>
                        <TextField id="outlined-basic" className='employee__infoInput' label="Employee Address" variant="outlined"
                            value={empAddress}
                            onChange={(e) => setAddress(e.target.value)} />

                        <Button  type= "submit" variant="contained" className='employee__infoButton' color='primary' style={{ margin: '15px ,0 ,0 ,15px', padding: '10px 20px 10px 20px' }}
                            onClick={handleClick }>
            ...
            <h1 style={{ color: 'dodgerblue', textAlign: 'center' }}>Employee's Information</h1>
        ...
        <React.Fragment key={rowIndex}>
            ...
            {row.map(employee => (
                ...
                <div>Employee Name : {employee.empName}</div>
                <div>Employee Email : {employee.empEmail}</div>
                <p>Employee DepartmentId : {employee.empDepId}</p>
                <p>Employee Salary : {employee.empSalary}</p>
